...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selecione o arquivo de texto");
    ...
    private void ProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProcurarActionPerformed
        ...
        file.setDialogTitle("Selecione o arquivo");
        file.setFileSelectionMode(JFileChooser.FILES_ONLY);
        file.showOpenDialog(this);
        caminhoArquivo = file.getSelectedFile();
        arquivo.setText(caminhoArquivo.getPath());
    }//GEN-LAST:event_ProcurarActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Inicio executa = new Inicio();
        try {
            executa.tratarArquivo(caminhoArquivo.getAbsolutePath());
